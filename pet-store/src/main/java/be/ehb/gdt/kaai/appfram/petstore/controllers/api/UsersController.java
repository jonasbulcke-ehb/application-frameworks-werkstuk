...
public class UsersController {
    ...
    public ResponseEntity<Map<String, String>> registerUser(HttpServletRequest request) {
        ...
        tokens.put("accessToken", jwtUtil.generateAccessToken(savedUser, request));
        tokens.put("refreshToken", jwtUtil.generateRefreshToken(savedUser.getUsername(), request));
