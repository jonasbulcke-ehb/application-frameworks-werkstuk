...
public class CartsController {
    ...
    /**
     * Handles the upsert van een item
     * @param productId id of the product to be added to the cart
     * @param amount amount of products to be added to the cart
     * @return the cart where the product is saved in or null if the upsert fails
     */
